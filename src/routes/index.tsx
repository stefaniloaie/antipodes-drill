...
const SITE_URL = "https://earthdrillexplorer.com/";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image:height", content: "630" },
      {
        ...
        content: "Antipodes Earth Drill — Dig Straight Through Earth Map Visualizer",
      },
      ...
      { name: "robots", content: "index, follow" },
      {
        name: "keywords",
        content:
          "antipode calculator, dig through earth, antipodal point, what is on the other side of earth, drill through earth, earth antipodes map, antipode guessing game, geography game",
      },
    ],
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: OG_IMAGE_URL,
          description:
            "Interactive antipode calculator — click any point on Earth to find the exact location on the opposite side of the globe, animated with a drill descent through Earth's layers.",
...
const COUNTRY_TABLE = [
  {
    ...
    lat: 34.5553,
    lng: 69.2075,
    antipodeLoc: "South Pacific Ocean",
  },
  {
    country: "Argentina",
    ...
    lat: -34.6037,
    lng: -58.3816,
    antipodeLoc: "Shanghai area, China",
  },
  {
    country: "Australia",
    capital: "Canberra",
    lat: -35.2809,
    lng: 149.13,
    antipodeLoc: "North Atlantic Ocean",
  },
  {
    country: "Brazil",
    capital: "Brasília",
  ...
  },
  {
    ...
    lat: 45.4215,
    lng: -75.6972,
    antipodeLoc: "South Indian Ocean",
  },
  {
    country: "Chile",
    capital: "Santiago",
    lat: -33.4489,
    lng: -70.6693,
    antipodeLoc: "Yellow Sea (China coast)",
  },
  {
    country: "China",
    capital: "Beijing",
    lat: 39.9042,
    lng: 116.4074,
    antipodeLoc: "South Atlantic Ocean (Argentina)",
  },
  {
    country: "Colombia",
    capital: "Bogotá",
    lat: 4.711,
    lng: -74.0721,
    antipodeLoc: "Indian Ocean (off Indonesia)",
  },
  {
    country: "Denmark",
    capital: "Copenhagen",
  ...
  },
  {
    ...
    lat: 48.8566,
    lng: 2.3522,
    antipodeLoc: "South Pacific Ocean (near NZ)",
  },
  {
    country: "Germany",
    capital: "Berlin",
  ...
  },
  {
    ...
    lat: -6.2088,
    lng: 106.8456,
    antipodeLoc: "Pacific Ocean (near Ecuador)",
  },
  {
    country: "Iran",
    capital: "Tehran",
  ...
  },
  {
    ...
    lat: 35.6762,
    lng: 139.6503,
    antipodeLoc: "South Atlantic (Uruguay coast)",
  },
  {
    country: "Kenya",
    capital: "Nairobi",
    lat: -1.2921,
    lng: 36.8219,
    antipodeLoc: "Pacific Ocean (north of Kiribati)",
  },
  {
    country: "Mexico",
    capital: "Mexico City",
  ...
  },
  {
    ...
    lat: -41.2865,
    lng: 174.7762,
    antipodeLoc: "Spain / Atlantic coast",
  },
  {
    country: "Nigeria",
    capital: "Abuja",
  ...
  },
  {
    ...
    lat: -12.0464,
    lng: -77.0428,
    antipodeLoc: "South China Sea / Gulf of Thailand",
  },
  {
    country: "Philippines",
    capital: "Manila",
    lat: 14.5995,
    lng: 120.9842,
    antipodeLoc: "Bolivia / Brazil border",
  },
  {
    country: "Poland",
    capital: "Warsaw",
  ...
  },
  {
    ...
    lat: -25.7479,
    lng: 28.2293,
    antipodeLoc: "North Pacific Ocean (west of Hawaii)",
  },
  {
    country: "South Korea",
    capital: "Seoul",
  ...
  },
  {
    ...
    lat: 40.4168,
    lng: -3.7038,
    antipodeLoc: "Wellington, New Zealand (land!)",
  },
  {
    country: "Sweden",
    capital: "Stockholm",
  ...
  },
  {
    ...
    lat: 13.7563,
    lng: 100.5018,
    antipodeLoc: "Pacific coast of Peru",
  },
  {
    country: "Turkey",
    capital: "Ankara",
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-base text-muted-foreground leading-relaxed">
                An <strong className="text-foreground">antipodal point</strong> is the location on
                Earth's surface that is diametrically opposite to a given point — the place you'd
                emerge if you could drill a perfectly straight tunnel through the center of the
                Earth. The word comes from the Greek
                <em> antipodes</em>, meaning "with feet opposite."
              </p>
              <p className="mt-4 text-base text-muted-foreground leading-relaxed">
                Calculating your antipode is straightforward geometry: negate your latitude and
                shift your longitude by 180°. If you stand at 40°N, 74°W (New York City), your
                antipode is at 40°S, 106°E — deep in the southern Indian Ocean, roughly 1,500 km
                south of Western Australia.
              </p>
              <p className="mt-4 text-base text-muted-foreground leading-relaxed">
                The surprising fact:{" "}
                <strong className="text-foreground">over 71% of Earth's surface is ocean</strong>,
                and the distribution of land vs ocean is highly asymmetric between hemispheres. The
                northern hemisphere holds most of the world's landmass, while the southern
                hemisphere is predominantly water. This means the antipode of almost any city you
                can name drops into open ocean.
              </p>
            </div>
            <div>
              ...
              <p className="mt-4 text-base text-muted-foreground leading-relaxed">
                ...
                living in Argentina or Chile — whose antipodes do land in parts of East Asia. For
                everyone else, it's ocean all the way down.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {[
              ...
              },
              {
                ...
                color: "var(--mantle-lower)",
              },
              {
                name: "Outer Core",
                depth: "2 890–5 150 km",
                temp: "4 400–5 000 °C",
                note: "Liquid iron generating Earth's magnetic field.",
                color: "var(--outer-core)",
              },
              {
                name: "Inner Core",
            ...
            {[
              {
                ...
                a: "An antipode is the point on Earth directly opposite any given location. Mathematically: negate the latitude and shift the longitude by 180°. If you're at 51°N, 0°E (London), your antipode is 51°S, 180°W — in the Pacific Ocean south of New Zealand.",
              },
              {
                q: "If I dig from the US, where do I come out?",
                a: "Anywhere in the continental United States lands in the Indian Ocean, south of the Kerguelen Islands. None of it is near China. Both the US and China are in the northern hemisphere — so neither is the other's antipode.",
              },
              {
                q: "Is the 'dig to China' myth true?",
                a: "No. China's antipodal region is mostly South Atlantic Ocean, near Argentina. Digging from the UK lands somewhere between New Zealand and Antarctica, not Asia.",
              },
              {
                q: "What percentage of land antipodes are ocean?",
                a: "Over 90% of the Earth's land surface is antipodal to open ocean. Land-to-land antipodal pairs are rare: New Zealand / Spain, Argentina / China, and a few island pairs are the classic examples.",
              },
              {
                q: "How hot is the Earth's core?",
                a: "The inner core is approximately 5,400 °C — comparable to the surface temperature of the Sun. The outer core is 4,400–5,000 °C and liquid. Pressure at the center reaches 360 gigapascals, roughly 3.6 million times atmospheric pressure.",
              },
              {
                q: "How does the antipode calculator work?",
                a: "The math is simple: antipode latitude = −latitude, antipode longitude = longitude ± 180°. Country detection uses the d3-geo geoContains function against the Natural Earth 110m dataset. Ocean naming uses geographic bounding boxes.",
              },
            ].map((item) => (
      ...
      <section className="border-t border-border bg-card">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <h2 className="mt-3 text-3xl text-foreground">
            Antipode of every country (capital city)
          </h2>
          <p className="mt-3 max-w-2xl text-base text-muted-foreground">
            Where each capital city emerges after drilling straight through the Earth. Click "Drill
            →" to explore.
          </p>
          <div
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {COUNTRY_TABLE.map((row, i) => (
                  <tr key={row.country} className={i % 2 === 0 ? "bg-background" : "bg-card"}>
