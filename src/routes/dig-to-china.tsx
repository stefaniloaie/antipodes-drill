...
const ORIGINS = [
  { place: "New York, USA", real: "South Indian Ocean", detail: "~1,500 km south of Western Australia. Open water, not Asia." },
  { place: "London, UK", real: "South Pacific Ocean", detail: "~2,000 km east of New Zealand. About as far from China as possible." },
  { place: "Paris, France", real: "South Pacific Ocean", detail: "Near New Zealand's antipodal waters." },
  { place: "Tokyo, Japan", real: "South Atlantic Ocean", detail: "Just off the coast of Uruguay." },
  { place: "Sydney, Australia", real: "North Atlantic Ocean", detail: "Halfway between Bermuda and the Azores." },
  { place: "Moscow, Russia", real: "South Pacific Ocean", detail: "Empty ocean, thousands of km from land." },
  { place: "Beijing, China", real: "South Atlantic Ocean", detail: "Even China doesn't dig to China — you'd surface near Argentina." },
];
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-6 py-12">
        ...
        <h2 className="mt-3 text-3xl text-foreground">Why digging to China is impossible (for most of us)</h2>
        <div className="mt-5 space-y-4 text-base text-muted-foreground leading-relaxed">
          <p>
            To dig to another country, that country must be your <strong className="text-foreground">antipode</strong> —
            the point diametrically opposite you, found by negating your latitude and shifting your longitude by 180°.
            China sits between roughly 20°N and 50°N. The United States, Canada and all of Europe are also in the
            northern hemisphere — so flipping the latitude alone already rules China out for all of them.
          </p>
          <p>
            The continental United States is antipodal to the <strong className="text-foreground">Indian Ocean</strong>,
            south of the Kerguelen Islands. Europe and the UK are antipodal to the <strong className="text-foreground">South
            Pacific Ocean</strong>, near New Zealand. Neither hemisphere-mate comes anywhere close to East Asia.
          </p>
          <p>
            The deeper reason is that Earth's land is lopsided: the northern hemisphere holds most of the landmass,
            while the southern hemisphere is mostly water. Over <strong className="text-foreground">90% of all land
            on Earth is antipodal to open ocean</strong> — which is why the drill almost always ends in a splash.
          </p>
        </div>
      </section>
          ...
          <div className="mt-8 overflow-hidden rounded-xl border border-border">
            <table className="w-full text-sm">
              <thead className="bg-background border-b border-border">
                <tr>
                  <th className="px-4 py-3 text-left font-mono text-xs text-muted-foreground uppercase tracking-wider">Dig from</th>
                  <th className="px-4 py-3 text-left font-mono text-xs text-muted-foreground uppercase tracking-wider">You emerge in</th>
                  <th className="hidden px-4 py-3 text-left font-mono text-xs text-muted-foreground uppercase tracking-wider sm:table-cell">Detail</th>
                </tr>
              </thead>
              <tbody>
                {ORIGINS.map((row, i) => (
        ...
        <div className="mx-auto max-w-4xl px-6 py-14">
          ...
          <div className="mt-5 space-y-4 text-base text-muted-foreground leading-relaxed">
            <p>
              ...
              <strong className="text-foreground">Argentina and central Chile</strong>. Buenos Aires drills through
              to the Shanghai area — the only major city-to-China pairing on the planet. If the idiom should belong
              to anyone, it's the Argentines.
            </p>
            <p>
              A few other rare land-to-land antipodes exist: Spain mirrors New Zealand, and Taiwan mirrors Paraguay.
              But for everyone else, the childhood promise of popping out in China ends several kilometres deep in
          ...
          <div className="mt-8 rounded-xl border border-primary/40 bg-card p-6 shadow-sm">
            ...
            <p className="mt-3 text-base text-muted-foreground">
              Click anywhere on the interactive map and watch the drill descend 12,742 km through the crust,
              mantle and 5,400 °C core to your exact antipodal point.
            </p>
