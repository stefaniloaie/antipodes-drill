  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Antipode Guessing Game — Where Does the Drill Come Out?" },
      {
        ...
        content: "A mystery city drills straight through Earth. Guess the antipodal exit point on an interactive map. Score 100% to become an Earth Whisperer.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: GAME_URL },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Antipode Guessing Game" },
      { name: "twitter:description", content: "Guess where a drill through the Earth comes out. Place your pin. Earn a title." },
      { name: "robots", content: "index, follow" },
      { name: "keywords", content: "antipode game, earth drill game, geography guessing game, antipodal point quiz, dig through earth game, geoguessr alternative, world geography game" },
    ],
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: GAME_URL,
          description: "An interactive geography game where a random world city drills through the Earth and players must guess the antipodal exit point on an interactive map.",
...
const MapFallback = (
  <div className="flex flex-1 items-center justify-center" style={{ minHeight: "calc(100vh - 160px)" }}>
          ...
          {!guess && (
            <div className="border-b border-border bg-muted/50 px-6 py-2">
              <p className="mx-auto max-w-6xl text-center font-mono text-xs tracking-wider text-muted-foreground">
                A famous city somewhere on Earth just drilled straight through. Mark where you think it came out.
              </p>
            </div>
          )}
          {guess && (
            <div className="border-b border-border bg-primary/5 px-6 py-2">
              <p className="mx-auto max-w-6xl text-center font-mono text-xs tracking-wider text-primary">
                Pin at {guess.lat.toFixed(3)}°, {guess.lng.toFixed(3)}° — click "Confirm guess" or reposition.
              </p>
            </div>
          )}
        ...
        <div className="min-h-screen bg-background">
          <div className="border-b border-border bg-card px-6 py-5">
            <div className="mx-auto max-w-6xl">
              ...
              <h1 className="mt-1 text-3xl text-foreground" style={{ fontFamily: "var(--font-display)" }}>
          ...
          <div className="mx-auto max-w-6xl px-6 py-8">
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-5">
                <div className="rounded-2xl border border-border bg-card p-7 shadow-sm">
                  <div className="text-center">
                    ...
                    <div className="mt-3 text-4xl text-foreground" style={{ fontFamily: "var(--font-display)", letterSpacing: "-0.02em" }}>
                      {Math.round(pct)}%
                    </div>
                    <div className="mt-1 text-xl text-primary" style={{ fontFamily: "var(--font-display)" }}>
                      {tier.title}
                    </div>
                ...
                <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                  ...
                  <p className="mt-2 text-3xl text-foreground" style={{ fontFamily: "var(--font-display)" }}>
              ...
              {/* Result map */}
              <Suspense fallback={<div className="flex items-center justify-center rounded-xl border border-border" style={{ minHeight: 480 }}><div className="h-6 w-6 animate-spin rounded-full border-2 border-primary border-t-transparent" /></div>}>
